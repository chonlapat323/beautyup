...
const styles = StyleSheet.create({
  ...
  typeText: { color: colors.goldDark, fontSize: 10, fontFamily: fonts.bold },
  heroEmail: { color: "rgba(255,255,255,0.5)", fontSize: 11, fontFamily: fonts.medium, marginTop: 2 },
  ...
  statVal: { color: colors.gold, fontSize: 14, fontFamily: fonts.extraBold },
  statLabel: { color: "rgba(255,255,255,0.6)", fontSize: 8, fontFamily: fonts.medium, textAlign: "center", lineHeight: 12 },
  ...
  ptsSub: { color: colors.textMuted, fontSize: 9, fontFamily: fonts.medium, marginTop: 1 },
  ptsPrimaryBtn: { backgroundColor: colors.gold, borderRadius: 999, paddingHorizontal: 14, paddingVertical: 7 },
  ptsPrimaryBtnText: { color: colors.goldDark, fontSize: 11, fontFamily: fonts.bold },
  ...
  creditLabel: { color: colors.textMuted, fontSize: 10, fontFamily: fonts.medium },
  ...
  creditBtnText: { color: colors.primary, fontSize: 11, fontFamily: fonts.bold },
  ...
  commLabel: { color: colors.textMuted, fontSize: 10, fontFamily: fonts.medium },
  commVal: { color: "#5B3FA0", fontSize: 15, fontFamily: fonts.bold, marginTop: 1 },
  commSub: { color: "#7A5CB8", fontSize: 11, fontFamily: fonts.medium },
  ...
  refLabel: { color: colors.textMuted, fontSize: 9, fontFamily: fonts.bold, letterSpacing: 0.8, textTransform: "uppercase", marginBottom: 5 },
  ...
  refBtnText: { color: colors.goldDeep, fontSize: 11, fontFamily: fonts.bold },
  ...
  bankTitle: { color: colors.textMuted, fontSize: 10, fontFamily: fonts.bold, textTransform: "uppercase", letterSpacing: 0.6 },
  bankEdit: { color: colors.goldDeep, fontSize: 11, fontFamily: fonts.bold },
  bankName: { color: colors.textPrimary, fontSize: 14, fontFamily: fonts.bold },
  bankSub: { color: colors.textMuted, fontSize: 11, fontFamily: fonts.medium, marginTop: 2 },
  ...
  menuItem: { flexDirection: "row", alignItems: "center", gap: 12, paddingHorizontal: 14, paddingVertical: 13, borderBottomWidth: 1, borderBottomColor: colors.goldMuted },
  menuIcon: { width: 32, height: 32, borderRadius: 16, backgroundColor: colors.goldSoft, alignItems: "center", justifyContent: "center" },
  menuIconDanger: { backgroundColor: "#FEE2E2" },
  menuLabel: { flex: 1, color: colors.textPrimary, fontSize: 13, fontFamily: fonts.semiBold },
  ...
  menuBadgeText: { color: colors.goldDark, fontSize: 9, fontFamily: fonts.bold },
