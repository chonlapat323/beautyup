...
const styles = StyleSheet.create({
  ...
  guestTitle: { color: colors.textPrimary, fontSize: 22, lineHeight: 30, fontFamily: fonts.bold, textAlign: "center", marginTop: spacing.xs },
  guestSub: { color: colors.textSecondary, textAlign: "center", fontSize: 14, lineHeight: 22, fontFamily: fonts.regular },
  ...
  guestFinePrint: { color: colors.textMuted, fontSize: 11, textAlign: "center", marginTop: -4, fontFamily: fonts.regular },
  ...
  outlineBtnText: { color: colors.gold, fontSize: 16, fontFamily: fonts.semiBold },
