...
const styles = StyleSheet.create({
  ...
  brandImgWrap: { width: 100, height: 86, position: "relative", flexShrink: 0, overflow: "hidden" },
  brandImg: { width: 100, height: 86, position: "absolute", top: 0, left: 0 },
  ...
  catImg: { position: "absolute", top: 0, left: 0, width: 72, height: 72 },
  catIconWrap: {
